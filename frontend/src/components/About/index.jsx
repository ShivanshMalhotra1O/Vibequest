			...
			<div className="flex flex-col items-center gap-4 px-4 py-16 mt-72 min-h-[calc(100dvh-485px)]">
				<div className="flex flex-col items-center max-w-5xl gap-4 text-justify">
					...
					<p className="text-lg">
						...
						designed to be fun and engaging, with a variety of gameplay modes to
						keep you entertained. Whether you&apos;re looking for a quick
					...
					<p className="text-lg">
						...
						experience for our players. Whether you&apos;re a casual gamer or a
						hardcore gamer, you&apos;ll find something to suit your preferences.
						Our games are designed to be fun and engaging, with a variety of
						gameplay modes to keep you entertained. Whether you&apos;re looking
						for a quick pick-up or a more challenging game, we&apos;ve got you
						covered.
					</p>
				</div>
			</div>
